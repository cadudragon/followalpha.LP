...
- [ ] **1.1** Primitives: `Tick`/`SqrtPriceX96`/`Price` conversions, `FeeTier`+tick spacing, `Liquidity`/`TokenAmount` (BigInteger/decimal), precision policy in one place. Gate: unit-tested, pure.
